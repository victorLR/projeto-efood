            ...
            <Row>
              <div>
                ...
                <Input
                  ...
                  onChange={({ target }) =>
                    setDelivery({ ...delivery, zipCode: target.value })
                  }
                  required
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={({ target }) =>
                    setDelivery({ ...delivery, number: target.value })
                  }
                  required
                />
              </div>
            ...
            <Row>
              <div>
                ...
                <Input
                  ...
                  onChange={({ target }) =>
                    setPayment({ ...payment, cardNumber: target.value })
                  }
                  required
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  value={payment.cvv}
                  onChange={({ target }) =>
                    setPayment({ ...payment, cvv: target.value })
                  }
                  required
                />
              </div>
            ...
            <Row>
              <div>
                ...
                <Input
                  ...
                  onChange={({ target }) =>
                    setPayment({ ...payment, expiresMonth: target.value })
                  }
                  required
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={({ target }) =>
                    setPayment({ ...payment, expiresYear: target.value })
                  }
                  required
                />
              </div>
